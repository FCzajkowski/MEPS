...
var V, H, U, W, G = 0, K = [], q = t, J = q.__b, Y = q.__r, X = q.diffed, ie = q.__c, ae = q.unmount, oe = q.__;
function se(e, t) {
...
function ue() {
	for (var e; e = K.shift();) {
		var t = e.__H;
		if (e.__P && t) try {
			t.__h.some(Z), t.__h.some(Q), t.__h = [];
		} catch (n) {
			t.__h = [], q.__e(n, e.__v);
		}
	}
...
q.__b = function(e) {
	...
	})) : (t.__h.some(Z), t.__h.some(Q), t.__h = [], V = 0)), U = H;
}, q.diffed = function(e) {
	X && X(e);
	var t = e.__c;
	...
	t.some(function(e) {
		try {
			e.__h.some(Z), e.__h = e.__h.filter(function(e) {
				return !e.__ || Q(e);
			});
		} catch (n) {
			t.some(function(e) {
...
re(/* @__PURE__ */ $(() => {
	...
	return /* @__PURE__ */ $("div", {
		...
		children: [
			/* @__PURE__ */ $("h1", { children: "Preact z JSX w Expressie!" }),
			/* @__PURE__ */ $("p", { children: ["Licznik: ", e] }),
			/* @__PURE__ */ $("button", {
				onClick: () => t(e + 1),
				children: "Zwiększ"
			})
